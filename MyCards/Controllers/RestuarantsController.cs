...
namespace MyCards.Controllers
{
    public class RestuarantsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RestuarantId,Name")] Restuarant restuarant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RestuarantId,Name")] Restuarant restuarant)
        {
            if (ModelState.IsValid)
            {
